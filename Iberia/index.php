...
spl_autoload_register(
  function (string $clase) { //$clase= nombre completo de una clase en el namespace
...
require_once __DIR__ .'/fuente/Controlador/reservaController.php'; /*controladores */
require_once __DIR__ .'/fuente/Controlador/RegistroController.php'; /*controladores */
require_once __DIR__ .'/fuente/Controlador/LoginController.php'; /*controladores */
